...
public class AddTeacher extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("tecaher");
        storageReference= FirebaseStorage.getInstance().getReference();

        String [] items= new String[] {"Select Category", "Computer Science ", "Mechanical", "Civil", "Other Department"};
    ...
    private void insertData() {
        ...
        dbRef.child(uniqueKey).setValue(teacherData).addOnSuccessListener((OnSuccessListener) (aVoid ) -> {
                pd.dismiss();
